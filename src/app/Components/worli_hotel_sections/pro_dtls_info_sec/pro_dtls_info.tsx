        ...
        <div className="cstm-cont-wdt">
          <div className='row '>
            <div className='col-lg-4 col-md-12 pro_dtls_name'>
                <h2 className='section_hd'>Worli Hotel</h2>
      ...
      <div className="cstm-cont-wdt porp_dtls_desc tab_padding">
        <div className="row ">
          <div className="col-lg-8 col-md-12">
            ...
            The Upper Upscale Hotel at Worli, Mumbai, exemplifies 13 years of operational excellence. Situated on 17 acres of prime land opposite the Four Seasons Hotel Mumbai, this 800-room upper upscale hotel represents a significant investment with a project cost of Rs. 1600 crores.
            </p>
          </div>
          ...
          <div className="col-lg-4 col-md-12 prop_dtls_bulletCon ">
            <ul>
              <li>
                <span>Prime Location:</span> 17 acres of prime land opposite Four Seasons Hotel Mumbai.                .  
              </li>

              <li>
                <span>Hotel Capacity:</span> 800-room upper upscale hotel.
              </li>
              <li>
